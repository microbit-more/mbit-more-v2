...
sed -e "s/let formatMessage = .*;/let formatMessage \= require('format-message');/" microbitMore/src/block/index.js > node_modules/scratch-vm/src/extensions/microbitMore/index.js
cp microbitMore/src/block/ble-web.js node_modules/scratch-vm/src/extensions/microbitMore/
cp microbitMore/src/block/ble-llk.js node_modules/scratch-vm/src/extensions/microbitMore/ble.js
cp microbitMore/src/block/serial-web.js node_modules/scratch-vm/src/extensions/microbitMore/
